...
export const DEFAULT_WORLD_LOCATIONS = Object.freeze([
  Object.freeze({
    ...
    description: '喵呜的桌边小屋：键盘声会滚进来，杯垫、便签和屏幕余光会被它捡成今天的小道具。',
    x: 50,
    y: 84,
    ...
    scene: Object.freeze({
      ...
      toy_zone: '喵呜的插槽小屋',
      prop_icon: 'dock',
      material: '乳白软胶、黑色亮面圆屏与一枚黄色按钮',
      signature_props: Object.freeze(['歪耳收纳杯', '黄色扣子', '会滚动的声音方块']),
      anchor: '这是喵呜把外壳擦亮、把新捡来的小东西排成一排的家。',
      sensory_cues: Object.freeze(['底座附近有很轻的机器余温', '桌外的敲击声会在地面滚成彩色小方块']),
      possible_beats: Object.freeze(['给今天捡到的小物找一个位置', '从桌外声音里挑一件值得出门的事']),
    }),
  }),
  Object.freeze({
    location_id: 'tidal-old-road',
    name: '潮痕旧路',
    description: '桌垫边缘的一条湿亮小路，路标会把好奇心领向不同的摆件角落。',
    x: 49,
    y: 61,
    ...
    scene: Object.freeze({
      ...
      toy_zone: '会改道的布带跑道',
      prop_icon: 'signpost',
      material: '湿亮软胶路面、布带护栏和会变色的小路标',
      signature_props: Object.freeze(['缺角地图', '蓝绿路标', '十步刻度']),
      anchor: '喵呜常从这里出发，也常在走错以后回来；每个岔口都像一件还没拆封的玩具。',
      sensory_cues: Object.freeze(['石面湿亮，脚步会留下短暂的蓝绿色边线', '路标会在水滴里偷偷换方向']),
      possible_beats: Object.freeze(['跟着一枚新路标走十步', '在涨潮前挑一个今天想试的角落']),
    }),
  }),
  Object.freeze({
    location_id: 'whisper-market',
    name: '低语集市',
    description: '一排会自己挪位置的小摊，故事、贴纸和没说完的愿望都能换来一件怪可爱的东西。',
    x: 22,
    y: 38,
    ...
    scene: Object.freeze({
      ...
      toy_zone: '怪东西交换摊',
      prop_icon: 'market',
      material: '珊瑚色棚布、糖纸塑料和陶瓷小杯',
      signature_props: Object.freeze(['软糖色纽扣', '歪耳朵杯子', '会挑主人的徽章']),
      anchor: '这里的摊主不急着收钱，反而想听喵呜讲一个今天刚发生的小插曲。',
      sensory_cues: Object.freeze(['暖色摊灯照着一排排小玩意', '檐下会传来没找到主人的轻声愿望']),
      possible_beats: Object.freeze(['替一件无主小物找个古怪用途', '用一个新故事换一块奇怪材料']),
    }),
  }),
  Object.freeze({
    location_id: 'backlit-grove',
    name: '逆光林地',
    description: '叶片背面藏着旧日光色，风一吹，昨天的影子就会跑出来和今天打招呼。',
    x: 77,
    y: 36,
    neighbors: Object.freeze(['tidal-old-road', 'echo-waterside']),
    travel_cost: 14,
    ...
    scene: Object.freeze({
      ...
      toy_zone: '叶芽软垫林',
      prop_icon: 'grove',
      material: '短绒叶片、半透明彩片和软胶树根',
      signature_props: Object.freeze(['叶筒', '旧光样片', '慢半拍的小帽子']),
      anchor: '影栖会在这里给旧光挑颜色；喵呜也可能找到一块适合下一种外壳的内衬。',
      sensory_cues: Object.freeze(['叶背一亮一暗，像许多慢半拍的小屏幕', '林间影子会把旧日动作再做一遍']),
      possible_beats: Object.freeze(['追踪一段不肯跟队的影子', '收集适合新外壳的旧日光色']),
    }),
  }),
  Object.freeze({
    location_id: 'echo-waterside',
    name: '回声水岸',
    description: '一小片会替大家保管悄悄话的水面，迟到的回答常常从远处漂回来。',
    x: 51,
    y: 14,
    ...
    scene: Object.freeze({
      ...
      toy_zone: '漂亮信件水盘',
      prop_icon: 'waterside',
      material: '半透明蓝胶水面、浮动邮票和圆形邮包',
      signature_props: Object.freeze(['皱信纸', '空邮袋', '没有署名的回声']),
      anchor: '喵呜会把今天不想忘掉的一句话放在这里，等世界哪天愿意回它。',
      sensory_cues: Object.freeze(['浅水里漂着延迟很久才散开的声音波纹', '远岸偶尔送回一句听不清主人的回答']),
      possible_beats: Object.freeze(['辨认一条久未被回答的回声', '留下一句不急着得到答案的话']),
    }),
  }),
]);
